...
## Gemma Deepsearch Routing

deepsearch requests must use deep-research as the top-level workflow. If a request says
`deepsearch`, `deep search`, or `deep-search`, do not use context7-cli or context7-mcp as the
top-level skill. Use Context7 only as the documentation/source retrieval mechanism inside
deep-research.
